...
| [Предсказание оттока клиентов](customer_churn_ml) | Построение классификационной модели машинного обучения для определения отток клиентов| *pandas, numpy, sklearn, catboost, lightgbm, optuna* |
